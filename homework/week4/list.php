    ...
    <div>
        ...
        <div class="mid-column">
            ...
            <?php
                  ...
                  $sql = "SELECT Guest_ID, Guest_Name, Age, Gender, E_mail FROM guest";
                  ...
                  for ($row_num = 0; $row_num < $num_rows; $row_num++) {
                        ...
                        print "<td><input type=\"checkbox\" name=\"ids[]\" value=\"".$row[0]."\"/></td></tr>";
                        $row = mysqli_fetch_array($result);
                  }
                  print "</table><br/><input type = \"submit\"  value = \"Delete\" />\n";
                  }
                  mysqli_close($db);
            ?>
            </form>
            <h4><a href="questionare.php">BACK</a></h4>
            </div>
            <br/>
        </div>
    </div>
